...
$GLOBALS['TL_LANG']['FFL']['tossn_captcha'] = ['Captcha Sicherheitsfrage', 'Dieses Feld fügt dem Formular ein Captcha als Grafik hinzu, welches zum Versenden des Formulars korrekt eingetragen werden muss.'];
