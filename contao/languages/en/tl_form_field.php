...
$GLOBALS['TL_LANG']['FFL']['tossn_captcha'] = ['Captcha security question', 'This field adds a captcha as image to the form, that has to be entered in order to submit the form.'];
